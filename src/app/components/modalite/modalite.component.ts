...
public nbrEcheanciers:number ;
  ...
  //End enregistrement  other contrat
  //Affichage des nbrEcheanciers
  inf4(){
      if(this.nbrEcheanciers < 4 ){
        return true;
      }else{
        return false
      }    
  ...
  inf7(){
    if(this.nbrEcheanciers >= 4 && this.nbrEcheanciers < 7 ){
      return true;
    }else{
      return false
    }    
  ...
  inf10(){
    if(this.nbrEcheanciers >= 7 && this.nbrEcheanciers < 10 ){
      return true;
    }else{
      return false
    }   
  ...
  inf13(){
    if(this.nbrEcheanciers >= 10 && this.nbrEcheanciers < 13){
      return true;
    }else{
      return false
    }     
